...
public class UpdateHealthAdapter extends PacketAdapter {
	...
	public void onPacketSending(PacketEvent event) {
		...
		if(saturation > 0) // If saturation is 0 the hunger bars will start shaking. To keep this vanilla behaviour we don't rewrite it if it's 0
			event.getPacket().getFloat().writeSafely(1, Float.NaN); // A value of nan will trick some indicators into not displaying anything
	}
