...
public enum Version {
	...
	V1_18_0("1.18-R0.1-SNAPSHOT", 757), V1_18_1("1.18.1-R0.1-SNAPSHOT", 757), V1_18_2("1.18.2-R0.1-SNAPSHOT", 758), V1_19("1.19-R0.1-SNAPSHOT", 759), UNKNOWN(null, Integer.MAX_VALUE);
